...
export const REFS = { R1: { s: "ISBSG 2023", d: "임베디드 8~15h/FP" }, R2: { s: "Capers Jones 2007", d: "Safety-critical 15~25h/FP" }, R3: { s: "COCOMO II", d: "Calibration" }, R6: { s: "VDA ASPICE PAM 3.1", d: "L2/L3 overhead" }, R7: { s: "Kugler Maag/SGS-TÜV", d: "ASIL +8~70% (활동 추가율)" }, R8: { s: "COCOMO II Reuse", d: "AAF=0.4DM+0.3CM+0.3IM, 재사용 5~20%" }, R9: { s: "Capers Jones 2010", d: "재사용 15~80%" }, R11: { s: "COCOMO II CPLX", d: "복잡도 5영역, L=0.87~XH=1.74" }, R12: { s: "IFPUG CPM", d: "FP: EI/EO/EQ + ILF/EIF 복잡도가중" }, R13: { s: "SPL Engineering 2005", d: "Variant 통합테스트 O(n·logn)~O(n²)" }, R14: { s: "ISO/SAE 21434 TARA", d: "Cyber: 영향도×공격가능성→위험값" }, R15: { s: "UNECE R155/R156", d: "OTA/SUMS, RXSWIN 형식승인" }, R16: { s: "OTA 실무", d: "3~20%" }, R19: { s: "COCOMO II SF", d: "규모 비선형" }, R25: { s: "Toyota VE", d: "인센티브 5~15%" }, R26: { s: "ISO 26262-3 §8", d: "FSC 안전메커니즘" }, R27: { s: "ISO 26262-4 §7", d: "TSC HW/SW배분" }, R28: { s: "ISO 26262-5", d: "HW DC" }, R29: { s: "ISO 26262-6", d: "SW rigor" }, R31: { s: "VDA L2→L3", d: "+15~25%" }, R32: { s: "ISO 26262-3 HARA", d: "ASIL 결정: S×E×C 결정표" } };
