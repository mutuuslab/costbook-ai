...
// 만원 단위 → 원화 환산 (예: 86714만 → "867,140,000원")
export function wonKRW(v) {
  return `${Math.round(v * 10000).toLocaleString()}원`;
}
